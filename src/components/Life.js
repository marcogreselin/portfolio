        ...
        return(
            <div className="Life">
                ...
                <div className="image-description">
                    ...
                    <div className="story">
                        <p>{ this.props.sayHello() }! I’m Marco and I love to build products that help people in their everyday lives. They call this the art of Product Management in the rehalm of tech companies.</p> 
