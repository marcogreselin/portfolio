...
export const Life = ({sayHello="Ciao"}) => (
    <div className="Life">
        ...
        <div className="image-description">
            ...
            <div className="story">
                <p>{ sayHello() }! I’m Marco and I love to build products that help people in their everyday lives. They call this the art of Product Management in the rehalm of tech companies.</p> 
