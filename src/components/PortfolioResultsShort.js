...
export const PortfolioResultsShort = () => (
    <div className="PortfolioResultsShort">
        <p className="left">
        ...
        <div className="left after">
            <a className="" href="https://www.github.com/marcogreselin" rel="noopener noreferrer" target="_blank"><i className="fa fa-instagram fa-2x" aria-hidden="true"></i><span className="hidden">GitHub</span></a><a href="https://www.instagram.com/marcogreselin" target="_blank" className="chat-link social" rel="noopener noreferrer">Instagram</a> should give you a sense of my personality.
        </div>

        <div className="left after">
            And my <a href="mailto:marcogreselin@me.com?subject=Let&#8217;s get a coffee!" className="chat-link social" rel="noopener noreferrer">email</a>, don't forget my email.
        </div>
